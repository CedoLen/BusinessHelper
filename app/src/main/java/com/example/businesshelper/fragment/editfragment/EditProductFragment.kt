...
class EditProductFragment(val data:Product) : Fragment(R.layout.fragment_edit_product) {
    ...
    override fun onCreateView(
        ...
        bind.editProductItem.setOnClickListener{
            ...
            data.rawMaterials = rawMaterials.text.toString().toDouble()
            data.salary =salary.text.toString().toDouble()
            data.socialNeeds=socialNeeds.text.toString().toDouble()
            data.depreciation=depreciation.text.toString().toDouble()
            data.taxes=taxes.text.toString().toDouble()
            data.storage=storage.text.toString().toDouble()
            data.other=other.text.toString().toDouble()
